...
import { gameIsNotValid } from '../utils/validator.js';

const editTemplate = (game, submitHandler) => html`
  <section id="edit-page" class="auth">
    <form id="edit" @submit=${submitHandler} method="POST">
      <div class="container">
        <h1>Edit Game</h1>
...
export const editView = ctx => {
  ...
  const submitHandler = e => {
    ...
    if (gameIsNotValid(gameData)) {
      alert('All fields are required!');
      return;
    }

    gameService.edit(gameId, gameData).then(() => {
